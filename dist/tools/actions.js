...
function scaleCoords(computerId, x, y) {
    ...
    registerOrgoTool(server, {
        ...
        handler: async ({ computer_id, start_x, start_y, end_x, end_y, duration }) => {
            try {
                ...
                return {
                    content: [{ type: "text", text: `Dragged (${start_x},${start_y}) -> (${end_x},${end_y})` }],
                };
            }
            catch (e) {
                return { content: [{ type: "text", text: handleError(e) }], isError: true };
